...
export class MapPage {
   ...
   */
  constructor(public navCtrl: NavController, public navParams: NavParams, public modalctrl: ModalController, public serverService: ServerProvider) {
  ...
  private addBusRoutes() {
    ...
    routes.forEach(({busRouteName, sections, colour}) => {
      sections.forEach(section => {
        let busRoutePath = exampleBusRouteCoordinates[section].positions;
        ...
        this.busRouteLines.set(busRouteName, busRoute);

        busRoute.setMap(this.map);
      });
    });

    let roundabout = new google.maps.Polygon({
