...
describe('ServerProvider', () => {
  ...
  describe('#getAllBuseStops', () => {
    it('Should return all data for each bus stop', () => {
      const dummyData: any = [
        {
  ...
  // This is just the inital request
  describe('#getBrassknockerHillBusStopData', () => {
    it("It should return all of Brassknocker Hill stop's data", () => {
      const dummyData: any = [
        {
          "location": {
            "latitude": 51.365948,
